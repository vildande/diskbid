...
import { ProductBidClosedNotChosen } from "../components/ProductBidClosedNotChosen";
import { useAuth } from "../hooks/useAuth";
import BidService from "../service/BidService";

export const BidResultsPage = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await BidService.getNotChosenClosedBids(user.token);
